...
class NameModel(models.Model):
	...
	user_create= models.ForeignKey(UserProfile, blank=True, default=1)
	#user_update = models.ForeignKey(UserProfile, related_name="update", blank=True)
...
class StudyHall(NameModel):
	...
	hall_pic = models.ImageField(default="logo.png",blank=True, null=True)
	def __str__(self):
